<template>
  ...
  <router-link
    ...
    class="btn-level"
    :class="{'active': level.active, 'current': current, 'disabled': level.disabled && !current}"
...
<style>
.btn-level {
  @apply px-1 py-4 ml-8 text-sm font-medium leading-5 whitespace-no-wrap border-b-2 border-transparent;
}
.level-btn:focus {
  @apply outline-none;
}
